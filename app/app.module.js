...
var createCustomerOpener = {'entity':{'displayName':'+ Create new Customer'}, 'dummy':true, 'fullName': '+ Create new Customer'};
var createTaskOpener = {'entity':{'taskName':'+ Create new task'}, 'taskName':'+ Create new task', 'dummy':true, 'attributes':{'taskName':'+ Create new task'}};
...
var CRM_URL = "https://merchantaccountcrm.com/ext_lead_import.php";
...
var invoicesUnlimited = angular.module('invoicesUnlimited', ['angularTrix','ui.router','oc.lazyLoad','ui.bootstrap','ngSanitize', 'cp.ngConfirm', 'ngMaterial','alexjoffroy.angular-loaders'])
