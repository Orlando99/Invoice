...
invoicesUnlimited.controller('InvoiceTemplateInfoController',[
	...
	function($q,$rootScope,$scope,$state,signUpFactory,userFactory,roleFactory){
		...
		function submitLeadToAggregator(){
			var lastName = "";
			...
			var obj = {
				'company': $scope.bsnsInfo.businessName,
				'mobile_phone': $scope.bsnsInfo.phoneNumber,
				'home_phone': $scope.bsnsInfo.phoneNumber,
				'business_phone': $scope.bsnsInfo.phoneNumber,
				'email_address': currentUser.get('email'),
				'first_name': firstName,
				'last_name': lastName,
				'position': IRIS_SOURCE
			}
			signUpFactory.submitLeadToAggregator(obj);
		}
